...
# FILTRO REAL 2026: Apenas casas permitidas e ativas no Brasil
ALLOWED_BOOKS = [
    "pinnacle", "betfair_ex", "bet365", "betano", "1xbet", "stake", "bwin"
]
...
if st.button("🚀 INICIAR VARREDURA AGRESSIVA"):
    with st.spinner(f"VARRENDO {esporte_label.upper()}..."):
        ...
        # Chamada principal da API com filtro na URL
        URL = f"https://api.the-odds-api.com/v4/sports/{target_sport}/odds/?apiKey={API_KEY}&regions=eu&markets=h2h&oddsFormat=decimal&bookmakers={BOOKS_QUERY}"
            ...
            if response.status_code != 200:
                ...
                for game in res:
                    ...
                    for book in game.get('bookmakers', []):
                        # FILTRO INTERNO NO LOOP (Bloqueia casas indesejadas que a API pode mandar)
